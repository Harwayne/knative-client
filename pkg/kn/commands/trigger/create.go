...
func NewTriggerCreateCommand(p *commands.KnParams) *cobra.Command {
  ...
  kn triggers create my-t --subscriber svc1

  # Create a trigger 'my-t' that sends all events sent to the 'other-b' Broker
  # to the Knative Service svc1.
  kn triggers create my-t --subscriber svc1 --broker other-b
  ...
  # Service svc1.
  kn triggers create my-t --subscriber svc1 --filter 'foo=bar,qux=garply'
  ...
  # importer.
  kn triggers create my-t --subscriber svc1 --importer CronJobSource
